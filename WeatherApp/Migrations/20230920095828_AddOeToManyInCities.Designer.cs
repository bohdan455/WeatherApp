...
namespace WeatherApp.Migrations
{
    ...
    [Migration("20230920095828_AddOeToManyInCities")]
    partial class AddOeToManyInCities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeatherApp.DataAccess.Entities.City", b =>
                {
                    ...
                    b.Property<int>("WeatherInformationId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WeatherInformationId");
            ...
            modelBuilder.Entity("WeatherApp.DataAccess.Entities.City", b =>
                {
                    b.HasOne("WeatherApp.DataAccess.Entities.WeatherInformation", "WeatherInformation")
                        .WithMany("Cities")
                        .HasForeignKey("WeatherInformationId")
